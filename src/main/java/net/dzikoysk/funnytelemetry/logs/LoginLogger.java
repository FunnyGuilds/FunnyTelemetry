...
public class LoginLogger implements ApplicationListener<AuthenticationSuccessEvent>
{
    ...
    {
        this.logService.submitLog(ActionType.LOGGED_IN, null, event.getAuthentication().getName(), ((OAuth2AuthenticationDetails) event.getAuthentication().getDetails()).getRemoteAddress());
    }
}
